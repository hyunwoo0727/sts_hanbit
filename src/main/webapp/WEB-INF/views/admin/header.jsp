  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right" style="height: 100%;">
        <li><a href="#" style="padding-top: 10%;"><button type="button" class="btn btn-default btn-lg" style="height: 40px;">
  <span class="glyphicon glyphicon-off" aria-hidden="true"></span>
</button></a></li>
        <li class="dropdown" style="height: 60px;">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" style="padding-top: 9%;">
